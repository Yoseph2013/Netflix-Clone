  ...
  return (
    <>
         <div className="relative h-screen text-white">
          <Navbar/>
          <img src={ORGINAL_IMG_BASE_URL + trendingContent?.backdrop_path}
              alt="Hero image"
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:32">    
            <div 
               className="gg-gradient-to-b from-black  via-transparent to-transparent absolute w-full h-full top-0 left-0 -z-10"/>
               ...
               <div className="flex mt-8">
                <Link to={`/wach/${trendingContent?.id}`}
                ...
                <Info className="size-6 inline-block mr-2 fill-black"/>
                    More Info 
                </Link>
